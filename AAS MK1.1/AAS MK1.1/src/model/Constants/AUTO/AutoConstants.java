package model.Constants.AUTO;

/**
 * Interface containing all constants used in the AUTO class
...
public interface AutoConstants
{
    ...
    String RECOGNITION_START = "command";                           // String for first answer in a dialogue with Auto
    String RECOGNITION_ABORTED = "understood";                      // String for answer when aborting dialogue with Auto
    ...
    String GREETING_RESPONSE = "greetings";                         // String for greeting response
    ...
    String TURN_OFF_RESPONSE = "should the termination of this program commence";// String for turn off response
    String SHUTDOWN_RESPONSE = "should a system shut down commence";// String for shutdown response
    String REBOOT_RESPONSE = "should a system reboot commence";     // String for reboot response
