...
public interface ActionQueueManagerConstants
{
    ...
    String BOOT_COMPLETE = "Initialization of AAS MK1.1 complete."; // String that should be printed to the terminal after startup
    String SHUTDOWN_COMPLETE = "ActionQueueManager: All components are shut down. Goodbye.";    // String that should be printed to the terminal before shutdown
}
