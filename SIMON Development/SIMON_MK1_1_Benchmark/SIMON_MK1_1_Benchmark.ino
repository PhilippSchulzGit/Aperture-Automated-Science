 ...
 * SIMON MK1.1 is used here.
 * This version changes the signaling procedure by utilizing the SIGNAL pin as a clock signal.
 * The single bits are then transmitted via the DATA pin when the clock signal is LOW.
 * The functionality to determine signal length is removed in this version.
 * 
