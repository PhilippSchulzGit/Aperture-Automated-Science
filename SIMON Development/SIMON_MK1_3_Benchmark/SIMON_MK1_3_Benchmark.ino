 ...
 * SIMON MK1.3 is used here.
 * This version refactors the existing code from MK1.2 regarding the usage of global variables. 
 * Especially the readSIMONData function has been re-written to use less local variables.
 * Function calls have been adjusted to receive references to variables, instead of calling global variables.
 * Additionally, the minimumSignalLength has been reduced to 50 us instead of the 1 ms.
 * 
...
const byte errorByte = 18;                            // data to send to indicate an error, binary is "010010010"
//-------------------------------------------Variables for protocol----------------------------------------
